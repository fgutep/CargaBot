...
#include "lab1_msgs/msg/detail/robot_action__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab1_msgs::msg::RobotAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lab1_msgs::msg::RobotAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lab1_msgs::msg::RobotAction *>(
    untyped_ros_message);
...
{
  return &lab1_msgs::msg::typesupport_fastrtps_cpp::_RobotAction__handle;
}
